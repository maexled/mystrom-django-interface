...
def mystrom_devices(request):
    if request.method == "POST":
        ...
        return render(request, "device_table_entries.html", {"devices": []})
    else:
        form = MystromDeviceForm()
    return render(
        request, "device_form.html", {"form": form, "device_type": "MystromDevice"}
    )
...
def shelly_devices(request):
    ...
    return render(
        request, "device_form.html", {"form": form, "device_type": "Shelly3EMDevice"}
    )
